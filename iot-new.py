...
mqtt_client_ID = "CwMiBRkjGA0MKyomJiAjDRQ"
mqtt_username  = "CwMiBRkjGA0MKyomJiAjDRQ"
mqtt_password  = "J6MzgqSqErBkc06SpMx9qzFT"
...
while not rospy.is_shutdown():
	...
	publish.single(topic, payload=tPayload, hostname=mqttHost, transport=tTransport, port=tPort, client_id=mqtt_client_ID, auth={'username':mqtt_username,'password':mqtt_password})
